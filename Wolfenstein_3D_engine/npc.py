...
class NPC(AnimatedSprite):
    def __init__(self, game, path=None, pos=(10.5, 5.5),
        ...
        path = path or resource_path('sprites', 'npc', 'soldier', '0.png')
    ...
    def check_health(self):
        if self.health < 1 and self.alive:
            self.alive = False
            self.game.object_handler.kills += 1
...
class CocoDemonNPC(NPC):
    def __init__(self, game, path=None, pos=(10.5, 6.5),
                 scale=0.7, shift=0.27, animation_time=250):
        path = path or resource_path('sprites', 'npc', 'caco_demon', '0.png')
        super().__init__(game, path, pos, scale, shift, animation_time)
...
class CyberDemonNPC(NPC):
    def __init__(self, game, path=None, pos=(11.5, 6.0),
        ...
        path = path or resource_path('sprites', 'npc', 'cyber_demon', '0.png')
        super().__init__(game, path, pos, scale, shift, animation_time)
        self.attack_dist = 6
        self.health = 200
