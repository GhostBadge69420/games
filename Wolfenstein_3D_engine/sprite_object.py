...
class SpriteObject:
    def __init__(self, game, path=None,
        ...
        self.x, self.y = pos
        path = path or resource_path('sprites', 'static_sprites', 'candlebra.png')
    ...
    def get_sprite(self):
        ...
        self.norm_dist = max(0.0001, self.dist * math.cos(delta))
...
class AnimatedSprite(SpriteObject):
    def __init__(self, game, path=None,
        ...
        path = path or resource_path('sprites', 'animated_sprites', 'green_light', '0.png')
